...
![Festival program overview](assets/images/wireframes-festival-program.png)<!-- .element: style="width: 35%;" -->
...
![Views layout strategies](assets/images/views-layout-strategies1.png)<!-- .element: style="width: 100%; heigth: 100%;" -->
...
![Festival Frontpage](assets/images/wireframes-festival-front.png)<!-- .element: style="width: 35%;" -->
